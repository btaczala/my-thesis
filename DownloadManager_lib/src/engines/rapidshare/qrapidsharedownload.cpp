...
// 	{
// 		//m_downloadInfo.m_FileInfo.m_FileSize = total ; 
// 		// just past it to the file ! 
// 		int bytesDownloadedOverall = (m_downloadInfo.m_FileInfo.m_FileSize - total) > 0 ?  m_downloadInfo.m_FileInfo.m_FileSize - total : 0 ; 
// 		m_downloadInfo.m_State.m_bytesDownloaded = done + bytesDownloadedOverall; 
// 		double dDone = m_downloadInfo.m_State.m_bytesDownloaded;
// 		double dTotal = m_downloadInfo.m_FileInfo.m_FileSize;
...
// 	if ( m_Progress == 0 ) 
// 	{
// 		if ( m_downloadInfo.m_State.m_bytesDownloaded != 0 && m_downloadInfo.m_FileInfo.m_FileSize != 0)
// 		{
// 			m_Progress = (double)((double)m_downloadInfo.m_State.m_bytesDownloaded / (double)m_downloadInfo.m_FileInfo.m_FileSize) * 100  ; 
// 		}
// 	}
// 	return m_Progress;
// }
...
// }
// 
// unsigned int QRapidshareDownload::GetFileSize() const
// {
// 	return m_downloadInfo.m_FileInfo.m_FileSize ; 
// }
// void QRapidshareDownload::SetFileSize( const unsigned int & fileSize )
// {
// 	m_downloadInfo.m_FileInfo.m_FileSize = fileSize ; 
// }